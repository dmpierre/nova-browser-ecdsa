...
export const Description: React.FC<{ total: number, type: string, iteration_count: number, per_iteration_count: number }> = ({ total, type, iteration_count, per_iteration_count }) => {
    return (
        <div className="text-center py-5 px-5">
            <p>
                This is an app aggregating {total} ECDSA signatures ({type} version) - {iteration_count} folding steps, {per_iteration_count} signatures per step - over secp/secq using Nova. You can test it to generate and subsquently verify a compressed Nova SNARK.
                <br /> <br />
